...
public class Constantes {
    ...
    static {
        ...
        ofertas.put(7, new Oferta(8, "Dulce o Truco", "Halloween en el Castillo Pittamiglio: El Castillito Embrujado", 270.0, new Empresa(8, "Pittamiglio Entertainments", "0900 2324", "Rambla Argentina 1234", "pitaEnter@gmail.com")));
        ofertas.put(8, new Oferta(9, "Sushi para 2", "Deleitate con el exquisito sushi de Umi Sushi &Cuisine de Carrasco", 500.0, new Empresa(9, "Sushi n go", "0900 1324", "Av Brasil 1234", "sushingo@gmail.com")));
        ofertas.put(9, new Oferta(10, "Tu auto a full", "$730 en vez de $2800 por recarga de aire de 400 g + chequeo + lavado para auto o camioneta", 2800.0, new Empresa(10, "Taller laRique", "0900 1324", "Rondeau 1234", "laRique@gmail.com")));
        ofertas.put(10, new Oferta(11, "Tu Cabello esplendido", "$790 en vez de $3000 por brushing progresivo u $890 en vez de $3490 con corte incluida en Cayetana", 790.0, new Empresa(11, "Peluqueria Celeste", "0900 1324", "Cno Maldonado 1234", "laPelu@gmail.com")));
        ofertas.put(11, new Oferta(12, "Arregla tu sonrisa", "$5500 en vez de $25000 por colocación de brackets estéticos de porcelana", 5500.0, new Empresa(12, "Consultorio Odontológico", "0933 1324", "Mercedes 1234", "dentistas@gmail.com")));
        ofertas.put(12, new Oferta(13, "Arregla tu Pc", "Formataso rapido por los ingenieros mas experimentados del mercado, con un mouse pad de regalo", 1000.0, new Empresa(13, "Texsis", "0933 1111", "Mercedes 1234", "texis@gmail.com")));
        ofertas.put(13, new Oferta(14, "Pack de Cerveza", "20 latas de cerveza Stela Artois 250ml", 500.0, new Empresa(14, "Stela Artois Sa", "0933 1324", "Mercedes 1234", "stelaArtois@gmail.com")));
        ofertas.put(14, new Oferta(15, "Luces led", "Carteleria led para tu negocio, auto, lo que quieras empezando por tan solo $1400", 1400.0, new Empresa(14, "Ledstar", "0933 1324", "Mercedes 1234", "ledstar@gmail.com")));
        ofertas.put(15, new Oferta(16, "Led Sony 47 pulgadas", "La mejor Tv al mejor precio Led Sony de 47 pulgadas a solamente $10000", 10000.0, new Empresa(15, "Sony", "0933 1324", "cno sonio 1234", "sony@gmail.com")));
        ofertas.put(16, new Oferta(17, "Tablet Chimichurry", "Directo de china el mejor tablet 2gb de RAM Quad Core Android 4.2 10'", 500.0, new Empresa(16, "Chimi CHumi", "0933 1324", "Rondeau 1234", "chimestry@gmail.com")));
